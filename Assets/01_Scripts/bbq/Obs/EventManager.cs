...
public static class EventManager
{
    ...
    public static void CreateAllEventInstance()
    {
        // foreach (Type type in Assembly.GetAssembly(typeof(GameEvent)).GetTypes())
        // {
        //     if (type.IsClass && !type.IsAbstract && type.IsSubclassOf(typeof(GameEvent)))
        //     {
        //         // 매개변수가 없는 기본 생성자를 통해 인스턴스 생성
        //         GameEvent instance = Activator.CreateInstance(type) as GameEvent;
        //         if (instance != null)
        //         {
        //             events.Add(instance);
        //             Debug.Log($"{type.Name} 인스턴스 생성됨");
        //         }
        //     }
        // }
    }
